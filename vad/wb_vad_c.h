...
#define FRAME_LEN 256//256 //400                     /* Length (samples) of the input frame          */
#define COMPLEN 12                         /* Number of sub-bands used by VAD              */
#define UNIRSHFT 7                         /* = log2(MAX_16/UNITY), UNITY = 256      */
#define SCALE 128//128     //450                          /* (UNITY*UNITY)/512 */
...
#define VAD_POW_LOW (Word32)5500000L         /* If input power is lower than this, VAD is set to 0 */                //!!!!!!!!!!!!
